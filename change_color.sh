...
rm -fr "${DEST_PATH}"
if [[ "$ARC_TRANSPARENCY" == "false" ]]; then
	mv ./distrib/share/themes/Arc-Deep-Darker-solid "${DEST_PATH}"
	if [[ -d ./distrib/share/themes/Arc-Deep-solid/cinnamon ]] ; then
		mv ./distrib/share/themes/Arc-Deep-solid/cinnamon "${DEST_PATH}"/cinnamon
	fi
	if [[ -d ./distrib/share/themes/Arc-Deep-solid/gnome-shell ]] ; then
		mv ./distrib/share/themes/Arc-Deep-solid/gnome-shell "${DEST_PATH}"/gnome-shell
	fi
else
	mv ./distrib/share/themes/Arc-Deep-Darker "${DEST_PATH}"
	if [[ -d ./distrib/share/themes/Arc-Deep/cinnamon ]] ; then
		mv ./distrib/share/themes/Arc-Deep/cinnamon "${DEST_PATH}"/cinnamon
	fi
	if [[ -d ./distrib/share/themes/Arc-Deep/gnome-shell ]] ; then
		mv ./distrib/share/themes/Arc-Deep/gnome-shell "${DEST_PATH}"/gnome-shell
	fi
fi
